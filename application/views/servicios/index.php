  ...
  <table class="table" id="tbl-servicios">
        ...
        <tbody>
            <?php foreach ($listadoServicios->result() as $servicio): ?>
                  ...
                  <img src="<?php echo base_url(); ?>/uploads/servicios/<?php echo $servicio->foto_servicio; ?>"
                  height="80px"
                  width="80px"
                  alt=""
                  ...
                  <td class="text-center">
                    <?php echo $servicio->fecha_ingreso_servicio; ?>
                  </td>
                  <td class="text-center">
                    <?php echo $servicio->fecha_actualizacion_servicio; ?>
                  </td>
                    <td class="text-center">
                        <a href="<?php echo site_url(); ?>/servicios/editar/<?php echo $servicio->id_servicio; ?>" class="btn btn-primary  ">
                          <i class="fa fa-edit"></i>
                        </a>

                        <?php if ($this->session->userdata("c0nectadoUTC")->tipo_usuario=="ADMINISTRADOR"): ?>
                          <a href="javascript:void(0)"
                           onclick="confirmarEliminacion('<?php echo $servicio->id_servicio; ?>');"
...
<script type="text/javascript">
    function confirmarEliminacion(id_servicio){
          iziToast.question({
              ...
              zindex: 999,
              title: 'CONFIRMACIÓN',
              message: '¿Esta seguro de eliminar el servicio de forma pernante?',
              position: 'center',
              buttons: [
                  ['<button><b>SI</b></button>', function (instance, toast) {
                      ...
                      "<?php echo site_url(); ?>/servicios/procesarEliminacion/"+id_servicio;
