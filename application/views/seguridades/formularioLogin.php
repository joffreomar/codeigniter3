...
<head>
    <meta charset="utf-8">
    <title>INICIO SESION - Bienvenido a EPAPAP</title>
                        ...
                        <div class="d-flex align-items-center justify-content-between mb-3">
                            <a href="<?php echo site_url(); ?>" class="">
                                <h3 class="text-primary text-center"><img src="<?php echo base_url(); ?>/assets/img/logo-epapap.png" alt="" width="70%" height="100%"></h3>
												...
												<form class="login100-form validate-form"  id="frm_formularioLogin" action="<?php echo site_url(); ?>/seguridades/validarAcceso" method="post">
                        <div class="form-floating mb-3 ">
                            <input class="form-control" type="email" name="correo_usuario" id="correo_usuario" placeholder="name@example.com" >
                            <label for="floatingInput"><i class="fa fa-envelope me-2"></i>Ingrese su correo</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input class="form-control" type="password" name="password_usuario" id="password_usuario" placeholder="contraseña" >
                            <label for="floatingPassword"><i class="fa fa-lock me-2"></i>Ingrese su contraseña</label>
                        </div>
                        <div class="d-flex align-items-center justify-content-between mb-4">
                            <a href="<?php echo site_url(); ?>/seguridades/formularioRecuperar">Olvidaste tu Contraseña</a>
                        </div>
                        <button type="submit" class="btn btn-primary py-3 w-100 mb-4"><i class="fas fa-sign-in-alt"></i> Ingresar</button>
											</form>
                    </div>
                </div>
            </div>
