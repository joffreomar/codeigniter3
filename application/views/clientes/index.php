                ...
                <tr>
                  ...
                  <?php if ($this->session->userdata("c0nectadoUTC")->tipo_usuario == "ADMINISTRADOR") : ?>
                    <td class="text-center">
                      ...
                      <?php if ($this->session->userdata("c0nectadoUTC")->tipo_usuario == "ADMINISTRADOR") : ?>
                        <a href="javascript:void(0)" onclick="confirmarEliminacion('<?php echo $cliente->id_cliente; ?>');" class="btn btn-danger">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <form method="post" id="carga_masiva" name="carga_masiva">
            <div class="mt-2">
              <label for="matriz_clientes">Archivo excel de Clientes</label>
