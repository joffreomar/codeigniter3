  ...
  <div class="bg-light  rounded p-4">
    ...
    <form class="row g-3" action="<?php echo site_url(); ?>/clientes/guardarCliente" method="post" id="frm_nuevo_cliente" enctype="multipart/form-data">
      ...
      <div class="col-md-12">
        ...
        <a href="<?php echo site_url(); ?>/clientes/index" class="btn btn-danger m-2">
          Cancelar
        </a>
      </div>
    </form>
      ...
      $("#frm_nuevo_cliente").validate({
        rules: {
          ...
          cedula_cliente: {
            ...
            maxlength: 10,
            remote: {
              url: "<?= base_url("index.php/clientes/verificarnumerocedula") ?>",
              type: "post",
              data: {
                cedula_cliente: function() {
                  return $('#cedula_cliente').val().trim();
                }
              }
            }
          },
          ...
          correo_cliente: {
            ...
            required: true,
            remote: {
              url: "<?= base_url("index.php/clientes/verificaremail") ?>",
              type: "post",
              data: {
                correo_cliente: function() {
                  return $('#correo_cliente').val().trim();
                }
              }
            }
          },
        ...
        messages: {
          ...
          cedula_cliente: {
            ...
            remote: "El número de cédula ya ha sido registrado anteriormente o no existe"
          },
          telefono_cliente: {
          ...
          correo_cliente: {
            ...
            remote: "El email ya ha sido registrado anteriormente"
          },
          estado_cliente: {
