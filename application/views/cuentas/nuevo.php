  ...
  <div class="bg-light  rounded p-4">
    ...
    <form class="row g-3" action="<?php echo site_url(); ?>/cuentas/guardarCuenta" method="post" id="frm_nuevo_cuenta" enctype="multipart/form-data">
      ...
      <div class="col-md-12">
        ...
        <a href="<?php echo site_url(); ?>/cuentas/index" class="btn btn-danger m-2">
          Cancelar
        </a>
      </div>
    </form>
      ...
      $("#frm_nuevo_cuenta").validate({
        rules: {
          ...
          numero_cuenta: {
            required: true,
            remote: {
              url: "<?= base_url("index.php/cuentas/verificarnumerocuenta") ?>",
              type: "post",
              data: {
                numero_cuenta: function() {
                  return $('#numero_cuenta').val().trim();
                }
              }
            }
          },
          numero_medidor_cuenta: {
            required: true,
            remote: {
              url: "<?= base_url("index.php/cuentas/verificarnumeromedidor") ?>",
              type: "post",
              data: {
                numero_medidor_cuenta: function() {
                  return $('#numero_medidor_cuenta').val().trim();
                }
              }
            }
          },
        ...
        messages: {
          ...
          numero_cuenta: {
            ...
            remote: "El número de cuenta ya ha sido registrado anteriormente"
          },
          numero_medidor_cuenta: {
            required: "Ingrese el numero de medidor",
            remote: "El número de medidor ya ha sido registrado anteriormente"
          },
          direccion_primaria_cuenta: {
